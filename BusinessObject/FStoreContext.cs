...
namespace BusinessObject
{
    public partial class FStoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server=localhost; database=FStore;uid=sa;password=123;TrustServerCertificate=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.ShipppedDate).HasColumnType("datetime");
